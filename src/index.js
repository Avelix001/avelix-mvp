...
function dashboardPage(){return shell('Dashboard',`<section class="dash-hero-premium">
<div class="dash-aurora aurora-purple"></div><div class="dash-aurora aurora-gold"></div><div class="dash-aurora aurora-red"></div>
<div class="dash-copy-premium"><div class="eyebrow gold-text">AVELYX • PROFESSIONAL IDENTITY</div><h1 id="welcome">Build a profile people can trust.</h1><p>Prove your potential with one professional identity, verified credentials and opportunities built around what you can actually show.</p><div class="dash-actions"><a class="btn premium-btn" href="/profile.html">Open My Profile</a><a class="btn ghost" href="/qr.html">Share My QR</a></div><div class="dash-trust-row"><span>✓ VERIFIED IDENTITY</span><span>✓ SECURE SHARING</span><span>✓ PROFESSIONAL PROFILE</span></div></div>
<div class="dash-logo-stage"><div class="logo-halo halo-one"></div><div class="logo-halo halo-two"></div><div class="logo-spark spark-one"></div><div class="logo-spark spark-two"></div><div class="dash-logo-card"><img src="/avelyx-verification-logo.png" alt="AVELYX Verification Logo"><div class="logo-check">✓</div></div><div class="dash-logo-caption">AVELYX VERIFIED</div></div></section>
<section class="dash-grid-premium"><a class="dash-tile-premium tile-purple" href="/profile.html"><span>01</span><b>My Professional Identity</b><small>Keep your AVELYX profile complete, polished and ready to share.</small><strong>→</strong></a><a class="dash-tile-premium tile-gold" href="/qr.html"><span>02</span><b>Secure QR</b><small>Share your professional identity instantly with one secure scan.</small><strong>→</strong></a><a class="dash-tile-premium tile-red" href="/permissions.html"><span>03</span><b>Information Permissions</b><small>Control exactly which protected information another person can access.</small><strong>→</strong></a><a class="dash-tile-premium tile-violet" href="/notifications.html"><span>04</span><b>Notifications</b><small>Stay informed about verification requests and important account activity.</small><strong>→</strong><span id="notificationBadge" class="badge" style="display:none">0</span></a><a class="dash-tile-premium tile-blue" href="/wallet.html"><span>05</span><b>AVX Wallet</b><small>View your AVX balance and account activity.</small><strong>→</strong></a><a class="dash-tile-premium tile-platinum" href="/opportunities.html"><span>06</span><b>Opportunities</b><small>Discover professional opportunities built around your verified identity.</small><strong>→</strong></a></section>
<section class="grid dash-bottom-premium"><div class="panel dashboard-stat-card stat-purple"><div class="eyebrow gold-text">YOUR AVELYX LEVEL</div><h2 id="levelTitle">Profile Level</h2><div id="identityBox" class="identity-card-premium">Loading...</div><a class="btn premium-btn" href="/profile.html" style="display:inline-block;margin-top:14px;text-decoration:none">Manage Profile</a></div><div class="panel dashboard-stat-card stat-gold"><div class="eyebrow gold-text">AVX WALLET</div><h2>Wallet</h2><div id="walletBox" class="identity-card-premium">Loading...</div><a class="btn ghost" href="/wallet.html" style="display:inline-block;margin-top:14px;text-decoration:none">Open Wallet</a></div></section>
<section class="dash-message-premium"><div><div class="eyebrow gold-text">THE AVELYX PROMISE</div><h2>Prove Your Potential.</h2><p>Build it. Verify it. Share it. Let your professional identity speak for you.</p></div><a href="/profile.html" class="btn premium-btn">Continue Building</a></section>`,`<style>
.dash-hero-premium{position:relative;overflow:hidden;display:flex;justify-content:space-between;align-items:center;gap:35px;padding:44px;border-radius:32px;border:1px solid rgba(212,174,74,.34);background:radial-gradient(circle at 80% 15%,rgba(139,77,255,.38),transparent 25%),radial-gradient(circle at 70% 90%,rgba(212,174,74,.18),transparent 27%),radial-gradient(circle at 20% 80%,rgba(255,55,95,.13),transparent 22%),linear-gradient(135deg,#070a1c,#111438 48%,#090c22);box-shadow:0 30px 90px rgba(0,0,0,.38),inset 0 0 80px rgba(139,77,255,.08)}
.dash-aurora{position:absolute;border-radius:50%;filter:blur(45px);pointer-events:none}.aurora-purple{width:190px;height:190px;right:24%;top:-90px;background:rgba(139,77,255,.28)}.aurora-gold{width:160px;height:160px;right:3%;bottom:-80px;background:rgba(212,174,74,.20)}.aurora-red{width:130px;height:130px;left:34%;bottom:-70px;background:rgba(255,55,95,.14)}
.dash-copy-premium{position:relative;z-index:2;max-width:720px}.dash-copy-premium h1{font-size:clamp(36px,5vw,62px);margin:10px 0 14px;letter-spacing:-2px;background:linear-gradient(90deg,#fff,#ddd5ff,#f2d78b);-webkit-background-clip:text;background-clip:text;color:transparent}.dash-copy-premium p{max-width:650px;color:#bfc8ea;line-height:1.75;margin:0}.dash-actions{display:flex;gap:10px;flex-wrap:wrap;margin-top:24px}.dash-trust-row{display:flex;gap:10px;flex-wrap:wrap;margin-top:20px}.dash-trust-row span{font-size:9px;letter-spacing:1.1px;color:#d8d0ff;padding:8px 11px;border-radius:999px;border:1px solid rgba(139,77,255,.25);background:rgba(10,12,35,.55)}
.dash-logo-stage{position:relative;width:230px;height:250px;flex:0 0 230px;display:grid;place-items:center;z-index:2}.dash-logo-card{position:relative;width:176px;height:176px;border-radius:42px;padding:9px;background:linear-gradient(145deg,#fff2b2,#d4ae4a 38%,#8b4dff 72%,#2c175f);box-shadow:0 0 35px rgba(139,77,255,.45),0 0 75px rgba(212,174,74,.16);transform:rotate(-2deg);animation:logoFloat 4s ease-in-out infinite}.dash-logo-card:before{content:'';position:absolute;inset:3px;border-radius:36px;background:#070914;z-index:0}.dash-logo-card img{position:relative;z-index:1;width:100%;height:100%;object-fit:cover;border-radius:34px;display:block}.logo-check{position:absolute;right:-10px;bottom:-10px;width:42px;height:42px;border-radius:50%;display:grid;place-items:center;background:linear-gradient(145deg,#8b4dff,#d4ae4a);color:#fff;border:4px solid #0b0d20;font-weight:1000;font-size:20px;box-shadow:0 0 20px rgba(139,77,255,.5);z-index:3}.dash-logo-caption{position:absolute;bottom:4px;letter-spacing:3px;font-size:10px;font-weight:900;color:#f2df9b;text-shadow:0 0 14px rgba(212,174,74,.5)}.logo-halo{position:absolute;border-radius:50%;border:1px solid rgba(212,174,74,.4)}.halo-one{inset:6px;border-top-color:#8b4dff;border-bottom-color:transparent;animation:spin 12s linear infinite}.halo-two{inset:24px;border-right-color:#ff375f;border-left-color:transparent;animation:spinReverse 9s linear infinite}.logo-spark{position:absolute;width:7px;height:7px;border-radius:50%;background:#fff;box-shadow:0 0 15px #fff,0 0 25px #8b4dff}.spark-one{top:25px;right:25px}.spark-two{bottom:52px;left:18px}
.dash-grid-premium{display:grid;grid-template-columns:repeat(3,1fr);gap:16px;margin-top:20px}.dash-tile-premium{position:relative;min-height:165px;padding:23px;border-radius:24px;color:#fff;text-decoration:none;overflow:hidden;border:1px solid rgba(255,255,255,.10);box-shadow:0 18px 45px rgba(0,0,0,.22);transition:transform .2s,border-color .2s,box-shadow .2s}.dash-tile-premium:before{content:'';position:absolute;width:130px;height:130px;border-radius:50%;right:-45px;top:-55px;filter:blur(10px);opacity:.65}.dash-tile-premium:hover{transform:translateY(-5px);border-color:rgba(255,255,255,.28);box-shadow:0 25px 55px rgba(0,0,0,.3)}.dash-tile-premium span:first-child{position:relative;font-size:10px;letter-spacing:2px;color:#d9def5;font-weight:900}.dash-tile-premium b{position:relative;display:block;font-size:18px;margin:13px 0 8px}.dash-tile-premium small{position:relative;display:block;color:#c2cae6;line-height:1.55;max-width:330px}.dash-tile-premium strong{position:absolute;right:20px;bottom:17px;font-size:24px;color:#fff}.tile-purple{background:linear-gradient(145deg,rgba(139,77,255,.36),#10142e 65%)}.tile-purple:before{background:#8b4dff}.tile-gold{background:linear-gradient(145deg,rgba(212,174,74,.32),#17172c 65%)}.tile-gold:before{background:#d4ae4a}.tile-red{background:linear-gradient(145deg,rgba(255,55,95,.28),#171022 65%)}.tile-red:before{background:#ff375f}.tile-violet{background:linear-gradient(145deg,rgba(105,62,210,.30),#10102a 65%)}.tile-violet:before{background:#a98cff}.tile-blue{background:linear-gradient(145deg,rgba(61,113,255,.25),#0d142c 65%)}.tile-blue:before{background:#4c8dff}.tile-platinum{background:linear-gradient(145deg,rgba(235,235,255,.20),#151528 65%)}.tile-platinum:before{background:#e5e2ff}.badge{position:absolute;right:16px;top:15px;min-width:25px;height:25px;border-radius:999px;background:#ff375f;text-align:center;line-height:25px;font-size:11px;font-weight:900;z-index:2}
.dash-bottom-premium{margin-top:20px}.dashboard-stat-card{position:relative;overflow:hidden}.dashboard-stat-card:after{content:'';position:absolute;width:180px;height:180px;border-radius:50%;right:-90px;top:-90px;filter:blur(25px);opacity:.25}.stat-purple:after{background:#8b4dff}.stat-gold:after{background:#d4ae4a}.identity-card-premium{position:relative;z-index:1;padding:20px;border-radius:18px;border:1px solid rgba(255,255,255,.10);background:linear-gradient(145deg,rgba(8,12,31,.9),rgba(24,19,52,.85));box-shadow:inset 0 0 30px rgba(139,77,255,.07)}.dash-message-premium{position:relative;overflow:hidden;margin-top:20px;padding:28px;border-radius:26px;border:1px solid rgba(212,174,74,.3);background:radial-gradient(circle at 85% 50%,rgba(212,174,74,.16),transparent 30%),linear-gradient(110deg,rgba(139,77,255,.18),rgba(255,55,95,.07),rgba(212,174,74,.10));display:flex;align-items:center;justify-content:space-between;gap:20px;box-shadow:0 20px 55px rgba(0,0,0,.2)}.dash-message-premium h2{margin:5px 0}.dash-message-premium p{margin:0;color:#bfc8e4}.dash-message-premium .btn{white-space:nowrap}
@keyframes logoFloat{0%,100%{transform:translateY(0) rotate(-2deg)}50%{transform:translateY(-8px) rotate(1deg)}}@keyframes spinReverse{to{transform:rotate(-360deg)}}
@media(max-width:850px){.dash-hero-premium{flex-direction:column;align-items:flex-start;padding:30px}.dash-logo-stage{align-self:center}.dash-grid-premium{grid-template-columns:1fr 1fr}}@media(max-width:520px){.dash-grid-premium{grid-template-columns:1fr}.dash-copy-premium h1{font-size:37px}.dash-logo-stage{transform:scale(.92);margin:-4px auto}.dash-trust-row span{font-size:8px}.dash-message-premium{flex-direction:column;align-items:flex-start}}
@media(prefers-reduced-motion:reduce){.dash-logo-card,.halo-one,.halo-two{animation:none}}
</style>`+memberGuardScript()+`<script>(async()=>{const p=await me();if(!p)return;document.getElementById('welcome').textContent='Welcome, '+p.full_name;document.getElementById('identityBox').innerHTML='<b>'+esc(p.avx_id)+'</b><br><span class="pill">'+esc((p.account_type||'individual').toUpperCase())+'</span> · '+esc((p.card_tier||'basic').toUpperCase())+'<br><small class="muted">'+esc(p.title||'Professional identity')+'</small>';document.getElementById('walletBox').innerHTML='<b style="font-size:24px">'+Number(p.avx_balance||0).toLocaleString()+' AVX</b><br><small class="muted">Your AVX wallet</small>';try{const r=await fetch('/api/information-requests',{credentials:'same-origin'});const d=await r.json();const n=(d.requests||[]).filter(x=>x.status==='pending').length;if(n){document.getElementById('notificationBadge').style.display='block';document.getElementById('notificationBadge').textContent=n}}catch(e){}})()</script>`)}
