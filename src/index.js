...
async function register(request, env) {
  ...
  if (!profileId) throw new Error('Could not create AVELIX profile.');
  ...
  try {
    ...
    if (!userId) throw new Error('Could not create AVELIX account.');
