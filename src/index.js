...
function dashboardPage(){return shell('Dashboard',`<section class="dash-hero"><div class="dash-copy"><div class="eyebrow">AVELYX • PROFESSIONAL IDENTITY</div><h1 id="welcome">Build a profile people can trust.</h1><p>Prove your potential with one professional identity, verified credentials and opportunities built around what you can actually show.</p><div class="dash-actions"><a class="btn" href="/profile.html">Open My Profile</a><a class="btn ghost" href="/qr.html">Share My QR</a></div></div><div class="dash-mark"><div class="mark-orbit"></div><div class="mark-core">A<span>♛</span></div><small>AVELYX VERIFIED</small></div></section><section class="dash-grid"><a class="dash-tile featured" href="/profile.html"><span>01</span><b>My Professional Identity</b><small>Keep your AVELYX profile complete and ready to share.</small></a><a class="dash-tile" href="/qr.html"><span>02</span><b>Secure QR</b><small>Share your professional profile in one scan.</small></a><a class="dash-tile" href="/permissions.html"><span>03</span><b>Information Permissions</b><small>Control what verified information you share.</small></a><a class="dash-tile" href="/notifications.html"><span>04</span><b>Notifications</b><small>Stay informed about requests and account activity.</small><span id="notificationBadge" class="badge" style="display:none">0</span></a><a class="dash-tile" href="/wallet.html"><span>05</span><b>AVX Wallet</b><small>View your AVX balance and account activity.</small></a><a class="dash-tile" href="/opportunities.html"><span>06</span><b>Opportunities</b><small>Discover professional opportunities through AVELYX.</small></a></section><section class="grid dash-bottom"><div class="panel"><div class="eyebrow">YOUR AVELYX LEVEL</div><h2 id="levelTitle">Profile Level</h2><div id="identityBox" class="identity-card">Loading...</div><a class="btn" href="/profile.html" style="display:inline-block;margin-top:14px;text-decoration:none">Manage Profile</a></div><div class="panel"><div class="eyebrow">AVX WALLET</div><h2>Wallet</h2><div id="walletBox" class="identity-card">Loading...</div><a class="btn ghost" href="/wallet.html" style="display:inline-block;margin-top:14px;text-decoration:none">Open Wallet</a></div></section><section class="dash-message"><div><div class="eyebrow">THE AVELYX PROMISE</div><h2>Prove Your Potential.</h2><p>Build it. Verify it. Share it. Let your professional identity speak for you.</p></div><a href="/profile.html" class="btn">Continue Building</a></section>`,`<style>.dash-hero{display:flex;justify-content:space-between;align-items:center;gap:30px;padding:34px;border-radius:28px;border:1px solid rgba(139,77,255,.3);background:radial-gradient(circle at 82% 25%,rgba(139,77,255,.26),transparent 28%),linear-gradient(135deg,#080d22,#111a3b 60%,#0c1027);box-shadow:0 25px 70px rgba(0,0,0,.22)}.dash-copy{max-width:700px}.dash-copy h1{font-size:clamp(34px,5vw,58px);margin:9px 0 12px;letter-spacing:-1.8px}.dash-copy p{max-width:650px;color:#b9c4e8;line-height:1.7;margin:0}.dash-actions{display:flex;gap:10px;flex-wrap:wrap;margin-top:22px}.dash-mark{width:170px;height:170px;flex:0 0 170px;display:grid;place-items:center;position:relative}.mark-orbit{position:absolute;inset:7px;border:1px dashed rgba(181,159,255,.65);border-radius:50%;animation:spin 13s linear infinite}.mark-orbit:before,.mark-orbit:after{content:'';position:absolute;width:9px;height:9px;border-radius:50%;background:#a98cff;box-shadow:0 0 18px #a98cff}.mark-orbit:before{top:7px;left:50%}.mark-orbit:after{bottom:18px;right:5px}.mark-core{width:108px;height:108px;border-radius:50%;display:grid;place-items:center;background:linear-gradient(145deg,#fff,#d7d0ff);color:#18142e;font-size:54px;font-weight:1000;font-style:italic;box-shadow:0 0 45px rgba(139,77,255,.45);position:relative;animation:pulse 3s ease-in-out infinite}.mark-core span{position:absolute;right:4px;bottom:4px;width:30px;height:30px;border-radius:50%;display:grid;place-items:center;background:#17132f;color:#fff;border:3px solid #fff;font-size:15px;font-style:normal}.dash-mark small{position:absolute;bottom:-7px;font-size:9px;letter-spacing:2px;color:#dce3ff;background:#111936;border:1px solid rgba(255,255,255,.12);padding:7px 10px;border-radius:999px}.dash-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:14px;margin-top:18px}.dash-tile{position:relative;min-height:145px;padding:21px;border:1px solid rgba(105,120,185,.22);border-radius:20px;background:linear-gradient(145deg,#0b122a,#080d20);color:#fff;text-decoration:none;transition:.18s;overflow:hidden}.dash-tile:hover{transform:translateY(-3px);border-color:rgba(139,77,255,.55)}.dash-tile.featured{background:linear-gradient(145deg,rgba(139,77,255,.18),#0b122a 65%);border-color:rgba(139,77,255,.4)}.dash-tile span:first-child{font-size:10px;letter-spacing:1.5px;color:#8d9ac1;font-weight:900}.dash-tile b{display:block;font-size:17px;margin:12px 0 7px}.dash-tile small{display:block;color:#9eabd0;line-height:1.55}.badge{position:absolute;right:14px;top:14px;min-width:24px;height:24px;border-radius:999px;background:#ff477e;text-align:center;line-height:24px;font-size:11px;font-weight:900}.dash-bottom{margin-top:18px}.identity-card{padding:18px;border:1px solid rgba(105,120,185,.24);border-radius:16px;background:linear-gradient(145deg,#080e23,#0c1430)}.dash-message{margin-top:18px;padding:24px;border-radius:22px;border:1px solid rgba(212,174,74,.24);background:linear-gradient(110deg,rgba(139,77,255,.12),rgba(212,174,74,.08));display:flex;align-items:center;justify-content:space-between;gap:20px}.dash-message h2{margin:5px 0}.dash-message p{margin:0;color:#aeb9dc}.dash-message .btn{white-space:nowrap}@media(max-width:800px){.dash-hero{flex-direction:column;align-items:flex-start}.dash-mark{align-self:center}.dash-grid{grid-template-columns:1fr 1fr}.dash-message{flex-direction:column;align-items:flex-start}}@media(max-width:520px){.dash-grid{grid-template-columns:1fr}.dash-copy h1{font-size:35px}}@media(prefers-reduced-motion:reduce){.mark-orbit,.mark-core{animation:none}}</style>`+memberGuardScript()+`<script>(async()=>{const p=await me();if(!p)return;document.getElementById('welcome').textContent='Welcome, '+p.full_name;document.getElementById('identityBox').innerHTML='<b>'+esc(p.avx_id)+'</b><br><span class="pill">'+esc((p.account_type||'individual').toUpperCase())+'</span> · '+esc((p.card_tier||'basic').toUpperCase())+'<br><small class="muted">'+esc(p.title||'Professional identity')+'</small>';document.getElementById('walletBox').innerHTML='<b style="font-size:24px">'+Number(p.avx_balance||0).toLocaleString()+' AVX</b><br><small class="muted">Your AVX wallet</small>';try{const r=await fetch('/api/information-requests',{credentials:'same-origin'});const d=await r.json();const n=(d.requests||[]).filter(x=>x.status==='pending').length;if(n){document.getElementById('notificationBadge').style.display='block';document.getElementById('notificationBadge').textContent=n}}catch(e){}})()</script>`)}
function profilePage(){return shell('My Profile',`<section class="profile-hero"><div class="profile-glow"></div><div class="verify-orbit"><div class="orbit-ring"></div><div class="verify-core"><span class="verify-a">A</span><span class="verify-check">✓</span></div><div class="orbit-label">AVELYX VERIFIED</div></div><div class="profile-hero-copy"><div class="eyebrow">MY PROFILE</div><h1>Professional Identity</h1><p>Your AVELYX identity, credentials and verification status — in one place.</p><div class="profile-mini-badges"><span>✦ Secure Identity</span><span>◉ Shareable QR</span><span>✓ Permission Controlled</span></div></div></section>
<section class="panel card-panel" style="margin-top:18px"><div class="eyebrow">YOUR AVELYX CARD</div><div class="card-head"><div><h2 id="cardTitle">AVELYX Card</h2><p id="cardSubtitle" class="muted">Your account level determines the card available to you.</p></div><span id="cardEligibility" class="pill">Loading...</span></div><div class="member-card-wrap"><img id="memberCardImage" class="member-card-image" src="/avelix-basic-card.png" alt="AVELYX Card"><div class="card-purchase"><button id="purchaseCardBtn" class="btn" onclick="purchaseCard()" disabled>Purchase Card</button><div id="purchaseMsg" class="muted" style="margin-top:10px"></div></div></div></section>
<section class="profile-layout"><div class="panel profile-panel"><div class="section-head"><div><div class="eyebrow">IDENTITY DETAILS</div><h2>Profile Information</h2><p class="muted">Keep your professional information accurate.</p></div><div class="live-dot"><i></i> LIVE</div></div><div id="profileForm"><div class="loading-card">Loading your profile…</div></div></div><div class="panel level-panel"><div class="eyebrow">AVELYX STATUS</div><h2>Profile Level</h2><div id="levelBox"><div class="loading-card">Loading your level…</div></div><div id="upgradeBox" style="margin-top:16px"></div><div class="level-road"><div class="road-title">YOUR JOURNEY</div><div id="journey"></div></div></div></section>
<section class="panel verification-center" style="margin-top:18px"><div class="section-head"><div><div class="eyebrow">AVELYX VERIFICATION CENTER</div><h2>Verify Your Credentials</h2><p class="muted">Submit your identity, education, professional or business credentials for review.</p></div><span class="pill">SECURE REVIEW</span></div><div id="verificationGrid" class="verification-grid"></div><div id="verificationForm" class="verification-form" style="display:none"><div class="grid"><div><label>Credential / document title *</label><input id="vtitle" placeholder="B.Sc. Computer Science"></div><div><label>Issuer</label><input id="vissuer" placeholder="University, employer or authority"></div><div><label>Reference / certificate number</label><input id="vreference" placeholder="Certificate or reference number"></div><div><label>Evidence link</label><input id="vevidence" placeholder="https://..."></div><div class="wide"><label>Notes</label><textarea id="vnotes" placeholder="Anything AVELYX should know about this credential"></textarea></div></div><div class="actions" style="margin-top:14px"><button class="btn" onclick="submitVerification()">Submit for Verification</button><button class="btn ghost" onclick="closeVerification()">Cancel</button></div><div id="vmsg"></div></div><div id="verificationRequests" style="margin-top:18px"></div></section>`,`<style>.profile-hero{position:relative;overflow:hidden;display:flex;align-items:center;gap:30px;padding:34px;border-radius:26px;border:1px solid rgba(100,120,220,.35);background:radial-gradient(circle at 82% 35%,rgba(103,80,255,.35),transparent 30%),linear-gradient(135deg,#080d22,#111a3b 55%,#0b1028);box-shadow:0 22px 60px rgba(0,0,0,.25);min-height:220px}.profile-glow{position:absolute;width:240px;height:240px;border-radius:50%;right:-80px;top:-80px;background:rgba(110,92,255,.18);filter:blur(10px)}.profile-hero-copy{position:relative;z-index:2;max-width:680px}.profile-hero h1{margin:6px 0 10px;font-size:clamp(32px,5vw,52px)}.profile-hero p{margin:0;color:#b9c4e8;line-height:1.65}.profile-mini-badges{display:flex;flex-wrap:wrap;gap:8px;margin-top:18px}.profile-mini-badges span{padding:8px 11px;border:1px solid rgba(255,255,255,.12);border-radius:999px;background:rgba(255,255,255,.05);font-size:11px;font-weight:800;color:#dce4ff}.verify-orbit{position:relative;width:150px;height:150px;flex:0 0 150px;display:grid;place-items:center}.orbit-ring{position:absolute;inset:4px;border-radius:50%;border:1px dashed rgba(152,165,255,.7);animation:spin 13s linear infinite}.orbit-ring:before,.orbit-ring:after{content:'';position:absolute;width:9px;height:9px;border-radius:50%;background:#8b7cff;box-shadow:0 0 18px #8b7cff}.orbit-ring:before{top:10px;left:50%}.orbit-ring:after{bottom:18px;right:10px}.verify-core{width:100px;height:100px;border-radius:50%;display:grid;place-items:center;background:linear-gradient(145deg,#fff,#cbd4ff);color:#10152e;box-shadow:0 0 0 8px rgba(255,255,255,.06),0 0 42px rgba(123,103,255,.5);position:relative}.verify-a{font-size:50px;font-weight:1000;font-style:italic}.verify-check{position:absolute;right:4px;bottom:4px;width:29px;height:29px;border-radius:50%;display:grid;place-items:center;background:#151d48;color:white;font-weight:1000;border:3px solid #fff}.orbit-label{position:absolute;bottom:-2px;white-space:nowrap;font-size:8px;font-weight:1000;letter-spacing:1.7px;color:#dce3ff;background:#111936;padding:7px 9px;border-radius:999px}.profile-layout{display:grid;grid-template-columns:minmax(0,1.7fr) minmax(280px,.8fr);gap:16px;margin-top:18px;align-items:start}.profile-panel,.level-panel,.verification-center{border-color:rgba(91,110,190,.28);box-shadow:0 12px 35px rgba(0,0,0,.12)}.section-head{display:flex;justify-content:space-between;gap:15px;align-items:flex-start}.section-head h2{margin:3px 0}.loading-card{padding:18px;border:1px dashed rgba(125,140,205,.3);border-radius:15px;color:#aeb9dc;background:rgba(255,255,255,.025)}.member-card-wrap{display:flex;flex-direction:column;align-items:center;margin-top:12px}.member-card-image{display:block;width:min(100%,520px);max-width:100%;height:auto;object-fit:contain;border-radius:16px}.card-purchase{width:100%;max-width:520px;margin-top:14px}.verification-grid{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:10px;margin-top:18px}.verify-option{padding:16px;border:1px solid rgba(255,255,255,.1);border-radius:16px;background:linear-gradient(160deg,#0e1633,#0a1025);cursor:pointer}.verify-option:hover{border-color:rgba(139,124,255,.7)}.verify-option b{display:block;margin-bottom:5px}.verify-option small{color:#8f9bbb}.verification-form{margin-top:18px;padding-top:18px;border-top:1px solid rgba(255,255,255,.08)}.verification-item{padding:13px;border:1px solid rgba(255,255,255,.08);border-radius:13px;margin-top:8px;background:rgba(255,255,255,.025)}.status-pending{color:#ffd27a}.status-verified{color:#78e5ad}.status-rejected{color:#ff91a5}@media(max-width:800px){.profile-hero{padding:25px;flex-direction:column;align-items:flex-start}.verify-orbit{width:125px;height:125px;flex-basis:125px}.verify-core{width:82px;height:82px}.verify-a{font-size:42px}.profile-layout{grid-template-columns:1fr}.verification-grid{grid-template-columns:1fr 1fr}.member-card-image{width:100%;max-width:100%}}@media(max-width:480px){.verification-grid{grid-template-columns:1fr}.member-card-image{border-radius:12px}}@keyframes spin{to{transform:rotate(360deg)}}</style>`+memberGuardScript()+`<script>
let profile=null, selectedVerificationType='';
const labels={individual:'Basic — Individual',entrepreneur:'Platinum — Entrepreneur / Professional',business:'Gold — Business / Organization'};
const escv=s=>String(s??'').replace(/[&<>]/g,c=>({'&':'&amp;','<':'&lt;','>':'&gt;'}[c]));
const attrv=s=>String(s??'').replace(/[&<>\"]/g,c=>({'&':'&amp;','<':'&lt;','>':'&gt;','\\':'&#92;','"':'&quot;'}[c]));
function formHtml(p){return '<div class="field"><b>'+escv(p.avx_id)+'</b><br><small class="muted">Your permanent AVELYX ID</small></div><label>Full name *</label><input id="full_name" value="'+attrv(p.full_name)+'"><label>Professional title</label><input id="title" value="'+attrv(p.title)+'"><label>Organization / business</label><input id="organization" value="'+attrv(p.organization)+'"><label>Industry</label><input id="industry" value="'+attrv(p.industry)+'"><label>Location</label><input id="location" value="'+attrv(p.location)+'"><label>Phone</label><input id="phone" value="'+attrv(p.phone)+'"><label>Website</label><input id="website" value="'+attrv(p.website)+'"><label>CAC / RC number</label><input id="cac_number" value="'+attrv(p.cac_number)+'"><label>Skills</label><input id="skills" value="'+attrv(p.skills)+'" placeholder="Python, CAD, marketing..."><label>Qualifications</label><textarea id="qualifications">'+escv(p.qualifications)+'</textarea><label>Certifications</label><textarea id="certifications">'+escv(p.certifications)+'</textarea><label>About</label><textarea id="bio">'+escv(p.bio)+'</textarea><button class="btn" style="margin-top:14px" onclick="saveProfile()">Save Changes</button><div id="msg"></div>'}
function renderLevel(){const t=profile.account_type||'individual';document.getElementById('levelBox').innerHTML='<span class="pill">'+labels[t]+'</span><div class="field" style="margin-top:14px"><b>AVELYX ID</b><br>'+escv(profile.avx_id)+'<br><b style="display:block;margin-top:10px">Card Tier</b>'+escv((profile.card_tier||'basic').toUpperCase())+'</div>';document.getElementById('upgradeBox').innerHTML=t==='individual'?'<p class="muted">Ready for more? Upgrade when your professional identity grows.</p><button class="btn" onclick="upgrade(\'entrepreneur\')">Upgrade to Platinum</button>':t==='entrepreneur'?'<span class="pill">PLATINUM ACTIVE</span><p class="muted">Ready to establish a business identity?</p><button class="btn" onclick="upgrade(\'business\')">Upgrade to Gold Business</button>':'<span class="pill">GOLD BUSINESS ACTIVE</span><p class="muted">Your business identity is active.</p>';document.getElementById('journey').innerHTML=['individual','entrepreneur','business'].map((x,i)=>'<div class="road-step '+(x===t?'active':'')+'"><b>0'+(i+1)+'</b><span>'+labels[x]+'</span></div>').join('')}
async function loadProfile(){try{const r=await fetch('/api/me',{credentials:'same-origin',cache:'no-store'});if(!r.ok)throw new Error('Profile API returned '+r.status);const d=await r.json();if(!d.profile)throw new Error('No profile returned');profile=d.profile;document.getElementById('profileForm').innerHTML=formHtml(profile);renderLevel()}catch(e){console.error(e);document.getElementById('profileForm').innerHTML='<div class="error">Unable to load profile. Please refresh and try again.</div>';document.getElementById('levelBox').innerHTML='<div class="error">Profile data could not be loaded.</div>'}}
async function saveProfile(){const r=await fetch('/api/profile',{method:'PUT',headers:{'content-type':'application/json'},credentials:'same-origin',body:JSON.stringify({full_name:document.getElementById('full_name').value,email:profile.login_email||profile.email,title:document.getElementById('title').value,organization:document.getElementById('organization').value,industry:document.getElementById('industry').value,location:document.getElementById('location').value,phone:document.getElementById('phone').value,website:document.getElementById('website').value,cac_number:document.getElementById('cac_number').value,skills:document.getElementById('skills').value,qualifications:document.getElementById('qualifications').value,certifications:document.getElementById('certifications').value,bio:document.getElementById('bio').value})});const d=await r.json();const m=document.getElementById('msg');m.className=r.ok?'toast':'error';m.textContent=r.ok?'Profile saved successfully.':(d.error||'Unable to save profile.');if(r.ok)await loadProfile()}
async function upgrade(target){let body={target_type:target};if(target==='business'){body.organization=prompt('Business / organization name:',profile.organization||'');if(!body.organization)return;body.industry=prompt('Industry:',profile.industry||'')||profile.industry;body.cac_number=prompt('CAC / RC number (optional):',profile.cac_number||'')||profile.cac_number}const r=await fetch('/api/profile/upgrade',{method:'POST',headers:{'content-type':'application/json'},credentials:'same-origin',body:JSON.stringify(body)});const d=await r.json();if(!r.ok){alert(d.error||'Unable to upgrade');return}alert(d.message);await loadProfile()}
async function loadCard(){const badge=document.getElementById('cardEligibility'),btn=document.getElementById('purchaseCardBtn'),img=document.getElementById('memberCardImage'),msg=document.getElementById('purchaseMsg');badge.textContent='Loading...';try{const r=await fetch('/api/card/status',{credentials:'same-origin',cache:'no-store'});const d=await r.json();if(!r.ok)throw new Error(d.error||('Card API '+r.status));const names={basic:'Basic Card',platinum:'Platinum Card',gold:'Gold Card'},files={basic:'/avelix-basic-card.png',platinum:'/avelix-platinum-card.png',gold:'/avelix-gold-card.png'};document.getElementById('cardTitle').textContent=names[d.card_tier]||'AVELYX Card';img.src=files[d.card_tier]||files.basic;if(d.eligible){badge.textContent='ELIGIBLE';btn.disabled=false;btn.textContent='Purchase '+(names[d.card_tier]||'Card');msg.textContent='Your required profile information and verification are complete.'}else{badge.textContent='VERIFICATION REQUIRED';btn.disabled=true;btn.textContent='Purchase Card';msg.textContent='Complete the items below before purchasing: '+(d.missing||[]).join(', ')}}catch(e){console.error(e);badge.textContent='VERIFICATION REQUIRED';btn.disabled=true;msg.textContent='Card eligibility could not be confirmed. Please complete verification and refresh.'}}
async function purchaseCard(){const btn=document.getElementById('purchaseCardBtn'),msg=document.getElementById('purchaseMsg');btn.disabled=true;const r=await fetch('/api/card/purchase',{method:'POST',credentials:'same-origin',headers:{'content-type':'application/json'},body:'{}'});const d=await r.json();msg.className=r.ok?'toast':'error';msg.textContent=r.ok?(d.message+' Reference: '+d.reference):((d.error||'Unable to purchase card.')+(d.missing?.length?' Missing: '+d.missing.join(', '):''));if(r.ok)btn.textContent='Order Created';else btn.disabled=false}
function openVerification(type){selectedVerificationType=type;document.getElementById('verificationForm').style.display='block';document.getElementById('vtitle').focus();document.getElementById('vmsg').textContent='Submitting '+type+' verification request.'}
function closeVerification(){document.getElementById('verificationForm').style.display='none';selectedVerificationType=''}
async function submitVerification(){const m=document.getElementById('vmsg');const r=await fetch('/api/verification-requests',{method:'POST',headers:{'content-type':'application/json'},credentials:'same-origin',body:JSON.stringify({verification_type:selectedVerificationType,title:document.getElementById('vtitle').value,issuer:document.getElementById('vissuer').value,reference:document.getElementById('vreference').value,evidence:document.getElementById('vevidence').value,notes:document.getElementById('vnotes').value})});const d=await r.json();m.className=r.ok?'toast':'error';m.textContent=d.message||d.error;if(r.ok){['vtitle','vissuer','vreference','vevidence','vnotes'].forEach(id=>document.getElementById(id).value='');closeVerification();loadVerifications()}}
async function loadVerifications(){const grid=document.getElementById('verificationGrid');grid.innerHTML=[['identity','Identity','Government ID / identity evidence'],['education','Education','Degree, diploma or academic record'],['professional','Professional','Employment or professional history'],['certification','Certification','Professional or technical certificate'],['business','Business','CAC / organization verification']].map(x=>'<div class="verify-option" onclick="openVerification(\''+x[0]+'\')"><b>'+x[1]+'</b><small>'+x[2]+'</small></div>').join('');const r=await fetch('/api/verification-requests',{credentials:'same-origin',cache:'no-store'});const d=await r.json();document.getElementById('verificationRequests').innerHTML='<div class="eyebrow">MY VERIFICATION REQUESTS</div>'+((d.requests||[]).map(x=>'<div class="verification-item"><b>'+escv(x.verification_type.toUpperCase())+'</b> <span class="status-'+escv(x.status)+'">'+escv(x.status.toUpperCase())+'</span><br><small class="muted">Submitted '+escv(x.created_at)+'</small></div>').join('')||'<p class="muted">No verification requests yet.</p>')}
(async()=>{await loadProfile();await loadCard();await loadVerifications()})();
</script>`)}
...
async function myVerificationRequests(request, env) {
  const user=await currentUser(request,env); if(!user) return json({error:'Please log in.'},401);
  try {
    const rows=await env.DB.prepare('SELECT id,verification_type,status,evidence,notes,created_at,updated_at FROM verification_requests WHERE profile_id=? ORDER BY id DESC LIMIT 50').bind(user.id).all();
    return json({requests:rows.results||[]});
  } catch(e) { return json({requests:[],error:'Verification center is not ready. Apply the verification migration first.'},200); }
}
async function createVerificationRequest(request, env) {
  const user=await currentUser(request,env); if(!user) return json({error:'Please log in.'},401);
  const b=await request.json();
  const type=String(b.verification_type||'').trim().toLowerCase();
  const allowed=['identity','education','professional','certification','business'];
  if(!allowed.includes(type)) return json({error:'Choose a valid verification type.'},400);
  const title=String(b.title||'').trim().slice(0,160);
  const issuer=String(b.issuer||'').trim().slice(0,160);
  const reference=String(b.reference||'').trim().slice(0,160);
  const evidence=String(b.evidence||'').trim().slice(0,500);
  const notes=String(b.notes||'').trim().slice(0,500);
  if(!title) return json({error:'Credential or document title is required.'},400);
  const payload=JSON.stringify({title,issuer,reference});
  try {
    const pending=await env.DB.prepare("SELECT id FROM verification_requests WHERE profile_id=? AND verification_type=? AND status='pending' LIMIT 1").bind(user.id,type).first();
    if(pending) return json({error:'A verification request of this type is already pending.'},409);
    const r=await env.DB.prepare('INSERT INTO verification_requests (profile_id,verification_type,status,evidence,notes) VALUES (?,?,?,?,?)').bind(user.id,type,'pending',JSON.stringify({credential:payload,evidence}),notes).run();
    await env.DB.prepare('INSERT INTO audit_logs (actor_user_id,action,target_type,target_id,details) VALUES (?,?,?,?,?)').bind(user.user_id,'verification.request','profile',user.avx_id,JSON.stringify({request_id:r.meta?.last_row_id,type,title,issuer,reference})).run();
    return json({ok:true,message:'Verification request submitted. AVELYX will review the details.',id:r.meta?.last_row_id},201);
  } catch(e) { return json({error:'Verification center is not ready. Apply the verification migration first.'},500); }
}
async function adminVerificationRequests(request, env) {
  const admin=await requireAdmin(request,env); if(!admin) return adminDenied();
  try { const rows=await env.DB.prepare(`SELECT r.*,p.full_name,p.avx_id,p.account_type FROM verification_requests r JOIN profiles p ON p.id=r.profile_id ORDER BY CASE WHEN r.status='pending' THEN 0 ELSE 1 END,r.created_at DESC LIMIT 100`).all(); return json({requests:rows.results||[]}); }
  catch(e){ return json({requests:[],error:'Verification migration not applied.'}); }
}
async function adminUpdateVerificationRequest(request, env) {
  const admin=await requireAdmin(request,env); if(!admin) return adminDenied();
  const b=await request.json(); const id=Number(b.id); const status=String(b.status||'').toLowerCase();
  if(!id || !['pending','verified','rejected'].includes(status)) return json({error:'Invalid verification request.'},400);
  try {
    const row=await env.DB.prepare('SELECT * FROM verification_requests WHERE id=?').bind(id).first(); if(!row) return json({error:'Verification request not found.'},404);
    await env.DB.prepare('UPDATE verification_requests SET status=?,updated_at=CURRENT_TIMESTAMP WHERE id=?').bind(status,id).run();
    if(status==='verified'){ try { const data=JSON.parse(row.evidence||'{}'); const c=data.credential||{}; const existing=await env.DB.prepare('SELECT id FROM credentials WHERE profile_id=? AND reference=? LIMIT 1').bind(row.profile_id,c.reference||('VR-'+id)).first(); if(!existing){ const cid='VER-'+crypto.randomUUID().replaceAll('-','').slice(0,14).toUpperCase(); await env.DB.prepare('INSERT INTO credentials (credential_id,profile_id,credential_type,title,issuer,reference,status,verified_at,notes,created_by_admin_email) VALUES (?,?,?,?,?,?,?,?,?,?)').bind(cid,row.profile_id,row.verification_type,c.title||row.verification_type,c.issuer||'',c.reference||('VR-'+id),'verified',now(),row.notes||'Verified from member verification request',admin.login_email).run(); } } catch(e) {} }
    await env.DB.prepare('INSERT INTO audit_logs (actor_user_id,action,target_type,target_id,details) VALUES (?,?,?,?,?)').bind(admin.user_id,'verification.request.status','verification_request',String(id),JSON.stringify({from:row.status,to:status})).run();
    return json({ok:true});
  } catch(e){ return json({error:'Verification migration not applied.'},500); }
}
...
export default { async fetch(request, env) {
  ...
  try {
    ...
    if (url.pathname === '/api/verification-requests' && request.method === 'GET') return await myVerificationRequests(request, env);
    if (url.pathname === '/api/verification-requests' && request.method === 'POST') return await createVerificationRequest(request, env);
    if (url.pathname === '/api/admin/verification-requests' && request.method === 'GET') return await adminVerificationRequests(request, env);
    if (url.pathname === '/api/admin/verification-requests/status' && request.method === 'POST') return await adminUpdateVerificationRequest(request, env);
